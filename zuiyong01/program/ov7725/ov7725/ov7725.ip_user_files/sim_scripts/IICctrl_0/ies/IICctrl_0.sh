...
#
# Generated by Vivado on Thu Nov 10 13:35:23 +0800 2016
...
# Script info
echo -e "IICctrl_0.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./IICctrl_0.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir/../../../../ov7725.srcs/sources_1/ip/IICctrl_0/sources_1/imports/src/I2C_Controller.v" \
    "$ref_dir/../../../../ov7725.srcs/sources_1/ip/IICctrl_0/sources_1/imports/src/IICctrl.v" \
    "$ref_dir/../../../../ov7725.srcs/sources_1/ip/IICctrl_0/sim/IICctrl_0.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.IICctrl_0 xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.IICctrl_0 -input simulate.do
}
# Script usage
usage()
{
